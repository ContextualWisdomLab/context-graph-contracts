...
def test_event_round_trip_preserves_extensions(asset_uri) -> None:
    """Structured JSON serialization preserves approved extension fields."""
...
def test_event_mapping_rejects_invalid_attributes(asset_uri, change, message) -> None:
...
def test_event_rejects_invalid_extensions(asset_uri, extensions, message) -> None:
...
def test_event_rejects_naive_time_and_non_mapping_data(asset_uri) -> None:
