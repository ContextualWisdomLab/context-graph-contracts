...
def test_build_parse_and_render_round_trip() -> None:
    """A valid UUIDv7-backed identifier round-trips exactly."""
...
def test_build_rejects_invalid_segments(field: str) -> None:
    """Segments must use bounded lower-snake identifiers."""
...
def test_build_rejects_non_uuid7(value: object) -> None:
...
def test_parse_rejects_noncanonical_text() -> None:
    """Parsing does not normalize encoded delimiters or uppercase text."""
