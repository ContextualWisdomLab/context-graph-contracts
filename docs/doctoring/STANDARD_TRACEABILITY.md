...
| Approved-vs-installed semantic evidence verification | National Institute of Standards and Technology (2015, FIPS 180-4) | ADR 0009; `verify_packaged_conformance_manifest()` and `cwl-context-conformance-verify`; exact version/profile mismatch regressions and fail-closed input handling |
