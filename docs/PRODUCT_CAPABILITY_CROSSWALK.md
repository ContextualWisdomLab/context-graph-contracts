...
| SDK/resource distribution | Python reference SDK plus packaged schemas/contracts/fixtures/profiles | wheel/sdist package smoke, Python 3.11–3.14 CI | Language-specific generated SDKs beyond the released baseline require separately governed artifacts |
